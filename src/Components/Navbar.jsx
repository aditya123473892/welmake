      ...
      >
        <div className="container mx-auto flex items-center justify-between px-6 py-6">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="/contact"
              className="text-blue-800 font-bold text-lg tracking-wide hover:text-blue-600 transition-colors duration-300 relative overflow-hidden group"
            >
          ...
          <div className="hidden sm:block">
            <a
              href="/order"
              className="bg-white text-blue-800 font-bold py-2 px-6 rounded-full shadow-md hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
            >
              Order Now
            </a>
          </div>
